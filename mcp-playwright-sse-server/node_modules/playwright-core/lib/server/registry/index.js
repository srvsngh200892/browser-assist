...
Run "${buildPlaywrightCLICommand(sdkLanguage, "install " + name)}"` : "";
  ...
  async _installImpl(executablesToInstall, forceReinstall) {
  ...
  async _downloadExecutable(descriptor, executablePath) {
    ...
    const downloadConnectionTimeoutEnv = (0, import_utils.getFromENV)("PLAYWRIGHT_DOWNLOAD_CONNECTION_TIMEOUT");
    const downloadConnectionTimeout = +(downloadConnectionTimeoutEnv || "0") || 3e4;
    await (0, import_browserFetcher.downloadBrowserWithProgressBar)(title, descriptor.dir, executablePath, downloadURLs, downloadFileName, downloadConnectionTimeout).catch((e) => {
