...
class WebSocketTransport {
  constructor(progress, url, logUrl, options) {
    ...
    this.wsEndpoint = url;
    this._logUrl = logUrl;
    const proxyAgent = (0, import_utils.createProxyAgent)(options.proxy, new URL(url));
    const happyEyeballsAgent = /^(https|wss):\/\//.test(url) ? import_happyEyeballs.httpsHappyEyeballsAgent : import_happyEyeballs.httpHappyEyeballsAgent;
