...
class LocalUtilsDispatcher extends import_dispatcher.Dispatcher {
  ...
  async connect(params, metadata) {
    ...
    return await controller.run(async (progress) => {
      ...
      const transport = await import_transport.WebSocketTransport.connect(progress, wsEndpoint, { headers: wsHeaders, followRedirects: true, debugLogHeader: "x-playwright-debug-log", proxy: params.proxy });
...
async function urlToWSEndpoint(progress, endpointURL, proxy) {
