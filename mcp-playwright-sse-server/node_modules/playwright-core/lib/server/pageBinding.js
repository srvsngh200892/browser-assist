...
function createPageBindingScript(playwrightBinding, name, needsHandle) {
  return `(${addPageBinding.toString()})(${JSON.stringify(playwrightBinding)}, ${JSON.stringify(name)}, ${needsHandle}, (${import_utilityScriptSerializers.source}), (${import_builtins.ensureBuiltins})(globalThis))`;
}
