...
async function launchApp(browserType, options) {
  ...
  const context = await browserType.launchPersistentContext((0, import_instrumentation.serverSideCallMetadata)(), "", {
    ...
    channel: options.persistentContextOptions?.channel ?? (!options.persistentContextOptions?.executablePath ? (0, import_registry.findChromiumChannel)(options.sdkLanguage) : void 0),
