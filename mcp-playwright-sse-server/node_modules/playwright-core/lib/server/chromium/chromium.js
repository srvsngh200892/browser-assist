...
class Chromium extends import_browserType.BrowserType {
  ...
  async _connectOverCDPInternal(progress, endpointURL, options, onClose) {
    ...
    const chromeTransport = await import_transport.WebSocketTransport.connect(progress, wsEndpoint, { headers: headersMap, proxy: options.proxy });
...
async function urlToWSEndpoint(progress, endpointURL, headers, proxy) {
