...
class ArtifactsRecorder {
  constructor(playwright, artifactsDir, screenshot, attachErrorContext2) {
    this._reusedContexts = /* @__PURE__ */ new Set();
    this._sourceCache = /* @__PURE__ */ new Map();
    this._playwright = playwright;
    this._artifactsDir = artifactsDir;
    this._attachErrorContext = attachErrorContext2;
  ...
  async didFinishTest() {
    ...
    if (this._attachErrorContext)
      await (0, import_prompt.attachErrorContext)(this._testInfo, this._pageSnapshot);
    else
      await (0, import_prompt.attachErrorPrompts)(this._testInfo, this._sourceCache, this._pageSnapshot);
  }
